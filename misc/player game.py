...
#keyboard binding
turtle.listen()
turtle.onkey((player.go_left(walls)), "Left")
turtle.onkey((player.go_right(walls)), "Right")
turtle.onkey((player.go_up(walls)), "Up")
turtle.onkey((player.go_down(walls)), "Down")
turtle.onkey((player.headright(missile,lives)), "d")
turtle.onkey((player.headleft(missile,lives)), "a")
turtle.onkey((player.headdown(missile,lives)),"s")
turtle.onkey((player.headup(missile,lives)),"w")
turtle.onkey((player.headright(missile,lives)),"D")
turtle.onkey((player.headleft(missile,lives)), "A")
turtle.onkey((player.headdown(missile,lives)),"S")
turtle.onkey((player.headup(missile,lives)),"W")
turtle.onkey((player.drink(info)),"space")
turtle.onkey((player.fireball(missile2,info,lives)),"z")
turtle.onkey((player.fireball(missile2,info,lives)),"Z")
